...
.L3:
	...
	movl	16(%rax), %edx
#APP
# 39 "overhead_to_sequential.cpp" 1
	addl $1,%edx
# 0 "" 2
#NO_APP
	movq	8(%rax), %r9
...
.LFE1024:
	...
	.p2align 4,,15
.globl _Z5incsdP11shared_dataIiEPv
	.type	_Z5incsdP11shared_dataIiEPv, @function
_Z5incsdP11shared_dataIiEPv:
.LFB1029:
	.cfi_startproc
	movl	16(%rdi), %eax
#APP
# 16 "overhead_to_sequential.cpp" 1
	addl $1,%eax
# 0 "" 2
# 16 "overhead_to_sequential.cpp" 1
	addl $1,%eax
...
#NO_APP
	...
	.cfi_endproc
.LFE1029:
	.size	_Z5incsdP11shared_dataIiEPv, .-_Z5incsdP11shared_dataIiEPv
	.p2align 4,,15
