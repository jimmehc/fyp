...
use Switch;
#my @algorithms = ("MCS", "pthread_lock", "control", "asymmetric", "asymmetric_var", "experiment", "experiment2", "experiment3", "experiment4", "queues", "message_passing");
my @algorithms = ("MCS", "control", "asymmetric", "asymmetric_var", "experiment", "experiment2", "experiment3", "experiment4", "queues", "message_passing");
my @options;
...
#		{
			...
			{
				print FILE $arr{"MCS"}{$option}/$arr{$algorithm}{$option};
			}
			else
			{
				print FILE 0;
